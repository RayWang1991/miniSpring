...
public interface BeanFactory {
     ...
     * @throws indi.ray.annotationSpring.core.beans.exception.NoSuchBeanDefinitionException
     * if there is no bean definition
     * @throws indi.ray.annotationSpring.core.beans.exception.BeansException
